...
def main(args):
    ...
    file = pd.read_csv(os.path.join(output_dir, "processed_trans.csv"), names=headerList)
    ...
    dfl = pd.read_csv(os.path.join(output_dir, "processed_labels_head.csv"), names= ["sessionID", "label"] )
